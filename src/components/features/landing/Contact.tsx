...
export function Contact() {
  const { contacto } = ODONTOLOGO_DATA;

  return (
    <section className="bg-emerald-50 px-5 py-16 sm:py-24" id="contacto">
      <div className="mx-auto max-w-3xl">
        <div className="mb-10 text-center">
          ...
          <p className="mt-4 text-lg text-slate-600">
            Estamos listos para recibirte. Reservá tu lugar hoy mismo.
          </p>
        </div>
        
        <div className="flex flex-col gap-6 rounded-3xl bg-white p-6 shadow-sm sm:p-10">
