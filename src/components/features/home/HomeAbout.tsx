    ...
    <section className="bg-white dark:bg-slate-950 px-6 py-24 sm:py-32 transition-colors duration-200" id="nosotros">
      <div className="mx-auto max-w-5xl text-center space-y-20">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-sm sm:text-base font-semibold text-slate-600 dark:text-slate-450">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          ...
          {/* Pillar 1 */}
          <div className="group bg-slate-50 dark:bg-slate-900/40 p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800/60 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/5 duration-350">
