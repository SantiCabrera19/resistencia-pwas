...
export function HomeHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-emerald-900/10 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md px-6 py-2 shadow-sm transition-colors duration-200">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => scrollTo("top")}>
          {/* Logo con un tamaño equilibrado y elegante, sin deformar la cabecera */}
